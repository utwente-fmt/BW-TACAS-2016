...
- The running example in our paper, is in the file `example.pnml`. To obtain the same permuted matrix use `pins2lts-sym example.so  --row-perm=1,2,0,5,3,4 --col-perm=1,2,3,4,0 --matrix`.
